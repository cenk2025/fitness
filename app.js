...
const i18n = {
  en: {
    ...
    'auth.terms.prefix':    'By signing up you agree to our ',
    'auth.terms.link1':     'Terms',
    'auth.terms.middle':    ' and ',
    'auth.terms.link2':     'Privacy Policy',
    'auth.terms.suffix':    '.',
    'auth.or':              'or',
    ...
    'auth.terms.prefix':   'Rekisteröitymällä hyväksyt ',
    'auth.terms.link1':    'käyttöehtomme',
    'auth.terms.middle':   ' ja ',
    'auth.terms.link2':    'tietosuojakäytäntömme',
    'auth.terms.suffix':   '.',
    'auth.or':             'veya',
